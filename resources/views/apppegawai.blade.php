    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-file-text"></i><span class="app-menu__label">Rekap Data</span><i class="treeview-indicator fa fa-angle-right"></i></a>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{route('pegawai/laporan')}}"><i class="icon fa fa-circle-o"></i> Laporan</a></li>
          </ul>
          <ul class="treeview-menu">
            <li><a class="treeview-item" href="{{route('pegawai/surat')}}"><i class="icon fa fa-circle-o"></i> Surat Menyurat</a></li>
          </ul>
        </li>
