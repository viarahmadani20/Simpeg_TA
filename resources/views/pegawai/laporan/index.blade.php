    ...
    <main class="app-content">
        <div class="app-title">
            ...
            <li class="breadcrumb-item"><a href="#">User</a></li> --}}
                <li class="app-search">
                    <form action="{{ route('pegawai/laporan') }}">
                        @csrf
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group col-md 8">
                            <a href="{{ route('pegawai/laporan/add') }}" class="btn btn-primary"><span class="fa fa-plus">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @if (isset($laporan->file))
                                                <a href="{{ asset('upload/' . $laporan->file) }}" target="_blank">Download
                                                    file</a>
                                            @else
                                                (Belum Diterima)
                                            @endif
                                        ...
                                        <td><a @if ($laporan->status == 'BelumDiterima') href="{{ route('pegawai/editlaporan', $laporan->id_lap) }}"class="btn btn-info d-inline-block"><span
