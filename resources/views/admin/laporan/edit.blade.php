            ...
            <div class="col-md-12">
                <div class="tile">
                    ...
                    <div class="tile-body">
                        ...
                        <form class="form-horizontal" method="post" action="{{ route('admin/lap_edit', $laporan->id) }}">
                            <div class="form-group row">
                                @csrf
                                <label class="control-label col-md-3">Nama Laporan</label>
                                <div class="col-md-8">
                                    <input class="form-control col-md-8" type="text" value="{{ $laporan->nama_laporan }}"
                                        name="nama_laporan">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-5">
                                    <input class="form-control col-md-8" type="file" value="{{ $laporan->file }}"
                                        name="file">
                                </div>
                            </div>
