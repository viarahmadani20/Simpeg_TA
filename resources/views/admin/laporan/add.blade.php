        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form class="form-horizontal" action="{{url('/admin/laporan')}}" method="post" action="{{route('admin/simpan_laporan')}}">
                <div class="form-group row">
                    @csrf
                  <label class="control-label col-md-3">Nama Laporan</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="text" name="nama_laporan">
                  </div>
                </div>
                <div class="form-group row">
            ...
            <div class="tile-footer">
              ...
              <div class="col-md-8 col-md-offset-3">
                  ...
                  <a class="btn btn-secondary" href="/admin/laporan"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                </div>
