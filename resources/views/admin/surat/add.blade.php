        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form class="form-horizontal" action="{{url('admin/surat')}}" method="post" action="{{('admin/simpan_surat')}}">
                  ...
                  <div class="col-md-9">
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" value="BelumVerifikasi" name="status">Laki-laki
                      </label>
                    </div>
                    <div class="form-check">
                      <label class="form-check-label">
                        <input class="form-check-input" type="radio" value="Diverifikasi" name="status">Perempuan
                      </label>
                    </div>
                    <div class="form-check">
                        <label class="form-check-label">
                          <input class="form-check-input" type="radio" value="Ditolak" name="status">Perempuan
                        </label>
                      </div>
                  </div>
                  <label class="control-label col-md-3">File Surat</label>
                  <div class="col-md-8">
                    <input class="form-control col-md-8" type="file" name="file_surat">
                  </div>
                </div>
            ...
            <div class="tile-footer">
              ...
              <div class="col-md-8 col-md-offset-3">
                  ...
                  <a class="btn btn-secondary" href="admin/surat"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                </div>
