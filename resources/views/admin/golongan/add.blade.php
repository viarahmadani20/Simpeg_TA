...
@section('content')
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-edit"></i> Tambah Pangkat/Golongan </h1>
                <!-- <p>Sample forms</p> -->
            </div>
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="#">Tambah Pangkat/Golongan </a></li>
            </ul>
        </div>
                            ...
                            <div class="tile-footer">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-3">
                                        ...
                                        <a class="btn btn-secondary" href="/admin/golongan"><i
