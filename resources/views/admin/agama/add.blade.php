...
<main class="app-content">
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="tile-body">
              <form class="form-horizontal" action="{{url('/admin/agama')}}" method="post" action="{{ route('admin/simpan_agama')}}">
            ...
            <div class="tile-footer">
              ...
              <div class="col-md-8 col-md-offset-3">
                  ...
                  <a class="btn btn-secondary" href="/admin/agama"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                </div>
