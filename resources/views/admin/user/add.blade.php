    ...
    <main class="app-content">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-body">
                        <form class="form-horizontal" method="post" action="{{ route('admin/simpan_user') }}" enctype="multipart/form-data">
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="agama" id="exampleSelect1">
                                        @foreach ($daftar_agama as $agama)
                                            <option value="{{ $agama->id }}" selected="">{{ $agama->nama_agama }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-md-8">
                                    <select class="form-control" name="pendidikan" id="exampleSelect1">
                                        @foreach ($daftar_pendidikan as $pendidikan)
                                            <option value="{{ $pendidikan->id_pendidikan }}" selected="">
