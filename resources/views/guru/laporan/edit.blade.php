        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form class="form-horizontal"  method="post" action="{{route('guru/lap_edit', $laporan->id_lap)}}" enctype="multipart/form-data">
            ...
            <div class="tile-footer">
              ...
              <div class="col-md-8 col-md-offset-3">
                  ...
                  <a class="btn btn-secondary" href="/guru/laporan"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                </div>
