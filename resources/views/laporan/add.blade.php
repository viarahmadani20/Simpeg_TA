        ...
        <div class="col-md-12">
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <form class="form-horizontal" action="{{url('/laporan')}}" method="post" action="{{route('simpan_laporan')}}">
            ...
            <div class="tile-footer">
              ...
              <div class="col-md-8 col-md-offset-3">
                  ...
                  <a class="btn btn-secondary" href="/laporan"><i class="fa fa-fw fa-lg fa-times-circle"></i>Kembali</a>
                </div>
